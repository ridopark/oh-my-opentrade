-- Parity diff: live (pre-bug) vs new-binary backtest (bt-a8069d6d2c126b92)
-- across 2026-04-29 + 2026-04-30. Joins on (symbol, bar_time) and reports
-- the count of bars where indicator fields diverge by more than the
-- 6-decimal-place noise floor.
