...
const families: Family[] = [
  ...
  },
  {
    ...
    name: "MACD",
    thesis:
      "MACD line/signal crossover with swing-based stops and dynamic R:R targets. Dark-pool block-flow veto suppresses entries against institutional pressure.",
    pf: "PF 1.3 – 1.6",
    caveat: "Higher false-signal rate, noisier",
  ...
  },
  {
    ...
    name: "AVWAP",
    thesis:
      "Anchored VWAP mean reversion from 5m/15m regime extremes. Confluence-weighted entries target fades during BALANCE or REVERSAL anchors.",
    pf: "PF 1.8 – 2.1",
    caveat: "Fastest to decay under crowding",
  ...
  },
  {
    ...
    name: "Confluence",
    thesis:
      "Scoring layer combining technical agreement (RSI/Stoch/ADX), dark-pool block ratio, and 13F whale accumulation. Gates all three strategies above.",
    pf: "0–100 score",
    ...
    <section id="strategies" className="landing-section border-b landing-hairline">
      <div className="mb-20">
        ...
        <h2 className="landing-display mt-6 text-[clamp(2rem,4.5vw,3.75rem)] max-w-4xl">
          Four signals.<br />One confluence gate.
        </h2>
      </div>
