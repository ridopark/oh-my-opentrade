...
func (m *mockRepo) RecordFillPerExec(context.Context, string, time.Time, float64, float64, domain.Trade) error {
	return nil
}
func (m *mockRepo) RecordFillAggregate(context.Context, string, time.Time, float64, float64, domain.Trade) error {
	return nil
}
...
func (m *mockRepo) GetRecordedExecutionIDs(_ context.Context, _ string, _ domain.EnvMode, _ time.Time) (map[string]struct{}, error) {
	return map[string]struct{}{}, nil
}

func (m *mockRepo) GetReconciledOrderIDs(_ context.Context, _ string, _ domain.EnvMode, _ time.Time) (map[string]struct{}, error) {
	return map[string]struct{}{}, nil
}
...
func (m *mockRepo) HasCanceledExitOrder(_ context.Context, _ string, _ domain.EnvMode, _ domain.Symbol) (bool, error) {
	return false, nil
}

func (m *mockRepo) HasTradeForBrokerOrderID(_ context.Context, _ string) (bool, error) {
	return false, nil
}
